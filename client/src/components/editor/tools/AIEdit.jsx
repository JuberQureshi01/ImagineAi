...
import { Wand2, Info, Sparkles, CheckCircle, AlertTriangle, Mountain, User, Camera } from "lucide-react";
...
export function AIEdit({ project }) {
  ...
  const applyRetouch = async () => {
    ...
    try {
      ...
      const retouchedImage = await FabricImage.fromURL(retouchedUrl, { crossOrigin: "anonymous" });
      ...
      // --- TRANSLATED PART ---
      // Replaced Convex mutation with a direct API call
